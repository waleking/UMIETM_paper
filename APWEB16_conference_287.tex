...
EDCoW\cite{weng2011event} & 0.731 & 0.435 \\ \hline
\end{tabular}
       \label{tab:metrics}
}
...
Burn-in period is set to 20 and optimize interval also 20, which means the priors are optimized every 20 iterations as the red curve in Figure \ref{fig:completeLoglikelihood}.
